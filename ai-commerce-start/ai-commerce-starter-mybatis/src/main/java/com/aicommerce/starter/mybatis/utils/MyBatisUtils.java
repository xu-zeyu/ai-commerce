package com.aicommerce.starter.mybatis.utils;
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        if (!CollectionUtils.isEmpty(sortingFields)) {
            page.addOrder(sortingFields.stream().map(sortingField -> SortingField.ORDER_ASC.equals(sortingField.getOrder())
                            ? OrderItem.asc(StringUtils.toUnderlineCase(sortingField.getField()))
                            : OrderItem.desc(StringUtils.toUnderlineCase(sortingField.getField())))
